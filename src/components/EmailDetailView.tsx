  ...
  const handleShare = () => {
    ...
    if (navigator.share) {
      navigator.share({
        ...
        // Suppress benign cancellation/abort errors
      ...
      if (onShowToast) {
        onShowToast('Email content copied to clipboard!', 'success');
      }
    }
  };
          ...
          <div className="flex items-center justify-between">
            ...
            {summary && !summaryLoading && (
              ...
              >
                ...
                <span>{t('detail.ai_regenerate')}</span>
              </button>
            )}
          </div>
          ...
          {summaryLoading && (
            <div className="space-y-2.5 py-2 animate-pulse">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs font-semibold text-slate-500 dark:text-slate-400">{t('detail.ai_summarizing')}</span>
              </div>
          ...
          {!summary && !summaryLoading && !summaryError && (
            <div className="py-2 flex flex-col items-start space-y-3">
              ...
              >
                ...
                <span>{t('detail.ai_summarize')}</span>
              </button>
            </div>
          )}
